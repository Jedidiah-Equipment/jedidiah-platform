import { departmentLabels, getDefaultQuoteDocumentLeadTime, resolveQuoteDocumentLeadTime } from '@pkg/domain/equipment';
...
export function GenerateQuoteDocumentModal({
  ...
  return (
    <ThemedModal backdropLabel="Close Generate Quote Document" dismissDisabled={isBusy} onClose={onClose} open={open}>
