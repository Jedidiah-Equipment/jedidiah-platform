...
export const ProductForm: React.FC<ProductFormProps> = ({ costingFooter, detailsFooter, onSave, product }) => {
  ...
  return (
    <form.AppForm>
      ...
      <AutosaveIssuesProvider issues={autosave.state.issues}>
                      ...
                      <form.AppField name="variantId">
                        {(field) => (
                          <field.SelectField
                            ...
                            placeholder={
                              productRangeVariantOptions.isPending ? 'Loading variants...' : 'Select variant'
                            }
                          />
                        )}
                      </form.AppField>
                    ...
                    <EditFormFullWidth>
                      <form.AppField name="description">
                        {(field) => (
                          <field.TextareaField
                            label={
                              <FieldUsageLabel usage={PRODUCT_FIELD_USAGE.description}>Description</FieldUsageLabel>
                            }
                            rows={4}
                          />
                        )}
