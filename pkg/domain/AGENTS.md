...
- `src/formatting/` is the only home of display formatters. `formatDate` takes one of six named formats:
  `short` (`3 Jun 2026`), `medium` (`3 Jun 2026, 14:05`), `long` (`Wednesday, 3 June 2026`), `day` (`3 Jun`),
  `time` (`14:05`), and `duration` (`5 days ago`, `in 2 days`, `just now`). A new shape is added there as a
