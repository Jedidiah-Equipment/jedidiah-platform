 ...
 * nobody browses. The stable field name is also the Job Activity projection boundary: only the work
 * Departments are curated into Work Time entries, never the surrounding raw audit change set.
 */
