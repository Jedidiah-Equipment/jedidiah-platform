...
6. Click **Create user**. To find contracting people, open **Filter Mode** and select **Contracting** and **Both**.
   This includes people who also hold an Equipment Role. Drivers and Mechanics read **Contracting** even though
   they cannot sign in. Clear the Mode filter with its **×** button to show all Modes again.
