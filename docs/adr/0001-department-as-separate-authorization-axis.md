...
- **Single axis — flat job editor/viewer roles with no Department membership at all.** Rejected: cannot express "Paint sees only Paint Stages" (PRD US #6, #8), which is a hard requirement.
