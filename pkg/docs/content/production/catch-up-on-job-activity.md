# Catch up on Job Activity

Use **Jobs → Activity** to read what has been said and done across every Job, newest first, without
opening each Job in turn.

1. Choose **Jobs**, then **Activity**.
2. Read down the feed. Each entry names who it was, when it happened, and the Job it is about.
3. Choose **Show more** on a long piece of feedback to read the rest of it.
4. Choose an entry to open that Job, where you can read its full feedback and submit your own with
   **Give feedback**.
5. Choose **Open on the Gantt** on an entry to open that Job in Planning instead.
6. Choose **Load more** to fetch the next batch of entries.
