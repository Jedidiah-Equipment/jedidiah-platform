...
import { bulkExportParts, bulkImportParts } from './part-bulk-service.js';
import { createPart, listParts } from './part-service.js';
...
describe('bulkImportParts and Part Categories', () => {
