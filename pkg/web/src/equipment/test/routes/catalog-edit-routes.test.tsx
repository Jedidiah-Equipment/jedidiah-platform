...
import { Route as ProductRangeEditRoute } from '@/routes/_authed.equipment.product-ranges.$id.edit.js';
import { Route as ProductEditRoute } from '@/routes/_authed.equipment.products.$id.edit.js';
