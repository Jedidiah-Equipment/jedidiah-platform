...
3. Edit it. Change cells, or add rows for Parts that do not exist yet. Leave the header row alone.
   Only change a **Code** to adjust its casing; any other Code edit creates a new Part. A **Catagory**
   cell must name a Part Category that already exists; add a new one under
