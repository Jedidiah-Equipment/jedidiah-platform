...
ALTER TABLE "equipment"."product_labor_hours" ADD CONSTRAINT "product_labor_hours_staff_count_min" CHECK ("equipment"."product_labor_hours"."staff_count" >= 1);--> statement-breakpoint
ALTER TABLE "equipment"."product_labor_hours" ADD CONSTRAINT "product_labor_hours_staff_count_max" CHECK ("equipment"."product_labor_hours"."staff_count" <= 999);