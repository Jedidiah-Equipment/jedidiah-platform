...
5. Local review:
   ...
   - Otherwise, use Codex review with GPT-5.5 and high reasoning:
     ```
     codex exec review --uncommitted --base main --model gpt-5.5 -c 'model_reasoning_effort="high"' "Review the uncommitted changes and the diff against main in this repo for bugs, missed edge cases, and convention violations. Be specific."
     ```
