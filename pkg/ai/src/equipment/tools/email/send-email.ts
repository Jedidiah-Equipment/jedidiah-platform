...
import type { AiContext, AiEmailAttachment } from '@/equipment/context.js';
import { GeneratedDocumentAttachment } from '@/equipment/generated-document.js';
...
export const sendEmailDefinition = {
  ...
  async handler(args: unknown, ctx: AiContext): Promise<SendEmailResponse> {
    ...
    const attachments: AiEmailAttachment[] = [];
...
function resolveRecipient(recipient: z.infer<typeof SendEmailRecipient>, ctx: AiContext): string {
