...
import {
  JEDIDIAH_FOOTER_BANNER_ASSET_PATH,
  JEDIDIAH_LOGO_ASSET_PATH,
  JEDIDIAH_MARK_WHITE_ASSET_PATH,
} from '@pkg/domain';
...
export const jedidiahMarkWhiteSrc = require.resolve(`@pkg/domain/assets/${JEDIDIAH_MARK_WHITE_ASSET_PATH}`);
