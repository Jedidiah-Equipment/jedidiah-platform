...
- **Wrong item** and **Defective** mean a replacement is coming. The line re-opens: its **Received**
  count drops back, the order returns to **Partially received**, the shortfall counts as **On order**
  again, and the replacement delivery is received without an over-receipt warning.
