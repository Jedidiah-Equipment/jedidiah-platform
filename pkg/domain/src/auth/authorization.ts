...
export const permissionLabels = {
  ...
  'equipment_part_category:update': 'Manage part categories',
  'equipment_part_category:merge': 'Merge part categories',
...
export const permissionDescriptions = {
  ...
  'equipment_part_category:merge': 'Merge duplicate Part Categories into one, moving their Parts.',
...
export const authorizationStatement = {
  ...
  equipment_part_category: ['update', 'merge'],
