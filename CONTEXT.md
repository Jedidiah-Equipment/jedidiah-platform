...
**Product Unit** is one physical machine. It owns the **Product Serial Number**, the Product it was built as, and an optional **VIN Number**. It is created with its Build Job and never on its own; a Custom Job produces none. Its **As-Built Spec** is the union of its Jobs' Build Specs, and it is **On Hand** once its Build Job has a Job Completion. Avoid Machine, Item, Asset, or Stock Item.
