...
const RESPONSE_STYLE_PROMPT = [
  ...
  'Example: for name "Compact Loader" and links.app "/equipment/products/123/edit", write `[Compact Loader](/equipment/products/123/edit)`.',
  ...
  'Example: for customer "Craig Stokes" and links.customer "/equipment/customers/456/edit", write `[Craig Stokes](/equipment/customers/456/edit)`.',
