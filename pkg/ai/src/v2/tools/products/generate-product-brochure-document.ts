...
import { createProductBrochureDownloadHref, InternalAppHref } from '@/v2/entity-links.js';
import { ProductBrochureDocumentAttachment } from '@/v2/generated-document.js';
...
export const generateProductBrochureDocumentDefinition = {
  ...
  requiredPermission: ['product:read', 'quote:create'],
  async handler(args: unknown, ctx: AiV2Context): Promise<GenerateProductBrochureDocumentResponse> {
