...
describe('JobDetail', () => {
  ...
  it('carries one Department Timing for each of the five work Departments', () => {
    ...
    const workDepartments = ['fabrication', 'paint', 'assembly', 'workshop', 'supply'];
