...
describe('CatalogTranslationNeedsReview', () => {
  it('renders affected fields and translation-tab links for every entity kind', () => {
    ...
    expect(html).toContain('/equipment/products/11111111-1111-4111-8111-111111111111/edit?tab=translations');
    expect(html).toContain('Trailers');
    expect(html).toContain('/equipment/product-ranges/22222222-2222-4222-8222-222222222222/edit?tab=translations');
