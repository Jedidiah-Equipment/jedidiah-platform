...
**General Feedback** (`general`) is Public Feedback: anyone who can read the subject can read it with attribution (submitter, date, text, Status), and anyone who can update the subject can change its Status. It carries no targets and never exposes Internal Notes. The submission form marks it PUBLIC.
