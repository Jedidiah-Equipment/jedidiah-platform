...
import { JobScheduleStateBadges } from '@/equipment/pages/jobs/components/JobScheduleStateBadges.js';
...
function QuoteCustomWorkCard({ quote }: { quote: Extract<QuoteDetail, { kind: 'custom' }> }) {
  ...
  return (
    <Card size="sm">
      <CardHeader>
        <CardDescription>{quoteOfferingTypeLabel(quote)}</CardDescription>
