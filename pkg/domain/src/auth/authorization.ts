...
export const permissionLabels = {
  ...
  'job_metrics:read': 'View build-time metrics',
  ...
  'product_unit:reassign': 'Reassign product units between deals',
...
export const permissionDescriptions = {
  ...
  'job:cancel': 'Cancel a job outright and remove its future slots, without touching its quote.',
  ...
  'purchase_order:approve': 'Approve draft Purchase Orders for sending.',
  'purchase_order:send': 'Send approved Purchase Orders to suppliers.',
...
export const authorizationStatement = {
  ...
  product_unit: ['read', 'update', 'transfer', 'reassign', 'remove'],
