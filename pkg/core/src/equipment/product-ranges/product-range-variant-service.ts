import { type DatabaseTransaction, type Db, getUniqueViolationConstraint, notRemoved } from '@pkg/db';
...
import { ProductRangeVariant as ProductRangeVariantSchema } from '@pkg/schema/equipment';
