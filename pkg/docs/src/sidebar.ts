...
export const CONTRACTING_SECTIONS: DocsSection[] = [
  {
    ...
    items: [
      ...
      { text: 'Set up a Job', link: '/contracting/set-up-a-job' },
      { text: 'Sign off a Job', link: '/contracting/sign-off-a-job' },
      { text: 'Price a Job', link: '/contracting/price-a-job' },
      { text: 'Stamp an Invoice Number', link: '/contracting/stamp-an-invoice-number' },
      { text: 'Print a Job Card', link: '/contracting/print-a-job-card' },
...
export const EQUIPMENT_SECTIONS: DocsSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Stamp Department work times', link: '/production/stamp-fabrication-times' },
      { text: 'Read Product build times', link: '/production/read-product-build-times' },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Receive a delivery', link: '/inventory/post-a-receipt' },
      {
        ...
        link: '/inventory/inspect-a-purchase-orders-audit-history',
      },
      ...
      { text: 'Control public Product Assemblies', link: '/inventory/control-public-product-assemblies' },
