...
**Farm** is the place the work happens, scoped to one Customer. Its spelling is kept consistent by selecting the existing Farm instead of retyping it; different Customers may have Farms with the same name.
